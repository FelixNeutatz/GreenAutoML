...
program = '/home/' + getpass.getuser() + '/Software/GreenAutoML/fastsklearnfeature/declarative_automl/optuna_package/myautoml/analysis/parallel_all_only_ensemble_random_classification_searchtime/check_model_parallel_per_data_minimum_all1.py'
outputname = 'ensemble'
...
session.attached_pane.send_keys('cd /home/' + getpass.getuser() + '/Software/GreenAutoML')
