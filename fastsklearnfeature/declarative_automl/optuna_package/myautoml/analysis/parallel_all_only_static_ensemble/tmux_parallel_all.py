...
program = '/home/neutatz/Software/GreenAutoML/fastsklearnfeature/declarative_automl/optuna_package/myautoml/analysis/parallel_all_only_static_ensemble/check_model_parallel_per_data_minimum_all1.py'
outputname = 'static_ensemble'

conda_name = 'GreenAutoMLD'

parallelism = 1#20#15#multiprocessing.cpu_count()
