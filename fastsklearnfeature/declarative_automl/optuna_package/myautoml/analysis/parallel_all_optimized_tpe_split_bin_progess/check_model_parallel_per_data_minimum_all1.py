        ...
        for number_iterations in [75, 150, 300, 600]:
            ...
            for repeat in range(10):
                ...
                try:
                    ...
                    trial = None
                    path_model = '/home/' + getpass.getuser() + '/data/my_temp/best_params_bin.p'
                    if len(np.unique(y_train_hold)) > 2:
                        path_model = '/home/' + getpass.getuser() + '/data/my_temp/best_params_multi.p'
