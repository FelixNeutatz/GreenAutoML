...
program = '/home/neutatz/Software/GreenAutoML/fastsklearnfeature/declarative_automl/optuna_package/myautoml/analysis/parallel_gama_new/check_model_parallel_gama.py'
outputname = 'gama'
