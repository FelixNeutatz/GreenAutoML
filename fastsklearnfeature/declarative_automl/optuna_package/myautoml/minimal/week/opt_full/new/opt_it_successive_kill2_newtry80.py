...
my_openml_tasks = [75118, 75126, 211722, 167203, 75154, 75178, 75223, 189878, 340, 167103, 189786, 190154, 167097, 75250, 75098, 189859, 2119, 236, 166996, 167204, 190157, 189869, 146597, 75134, 75237, 190156, 2356, 190155, 245, 189840, 189845, 271, 75176, 126030, 167205, 189846, 189887, 75195, 75169, 146594, 2121, 211723, 189870, 189829, 167085, 254, 75221, 189900, 75108, 189828, 126021, 126028, 189875, 75235, 189858, 211720, 75146, 189836, 189843, 126031, 75093, 75156, 75236, 275, 189779, 211724, 189864, 167202, 336, 167086, 260, 75174, 3047, 167100, 258, 126024, 146576, 256, 189863, 146592]
#np.random.seed(42)
    ...
    for random_i in range(repetitions_count):
        ...
        for dataset_i in range(len(validation_datasets)):
            ...
            try:
                ...
                with open('/home/' + getpass.getuser() + '/data/my_temp/best_params80.p', "wb+") as pickle_model_file:
