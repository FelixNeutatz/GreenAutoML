...
my_openml_tasks = [2121, 273, 75126, 211722, 75154, 167203, 75134, 189878, 211723, 189836]
#np.random.seed(42)
    ...
    for random_i in range(repetitions_count):
        ...
        for dataset_i in range(len(validation_datasets)):
            ...
            try:
                ...
                with open('/home/' + getpass.getuser() + '/data/my_temp/best_params10.p', "wb+") as pickle_model_file:
